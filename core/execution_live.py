...
class LiveExecutionEngine:
    ...
    def handle_signal(self, signal: Signal) -> LiveExecutionResult:
        ...
        if signal.action == SignalAction.ENTER_LONG:
            ...
            # EXIT signals are currently not generated by the strategy; exits
            # are managed via brackets/forced flat.
            return LiveExecutionResult(order=None, rejection_reason="EXIT signals not supported in live engine.")
