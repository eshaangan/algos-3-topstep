...
- Generated: `2026-04-12T23:58:04.882803Z`
- Overall pass: `False`
- Passing windows: `3/5`
- Pass ratio: `0.60`
- Overall total PnL: `$643.19`

## Overall Direction

- Long trades: `94`
- Short trades: `88`
- Long share: `0.5164835164835165`
- Short share: `0.4835164835164835`
...
- Failures:
  - `total_pnl_usd` actual=`-684.8071968321801` expected=`>= 0.0`
  - `avg_trade_usd` actual=`-13.975657078207758` expected=`>= 3.0`
  - `profit_factor` actual=`0.7118513393875194` expected=`>= 1.05`
  - `win_rate` actual=`0.4489795918367347` expected=`>= 0.45`
